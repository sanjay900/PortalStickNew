...
public class Vector3 implements Serializable, Vector<Vector3> {
	...
	/** Constructs a vector from a bukkit vector 
	 * Y and Z get flipped because minecraft is weird.
	 * */
	public Vector3 (org.bukkit.util.Vector vector) {
		this.set((float)vector.getX(),(float)vector.getZ(),(float)vector.getY());
	}
	...
	public org.bukkit.util.Vector getVector() {
		return new org.bukkit.util.Vector(this.x,this.z,this.y);
	}
}
